...
val canonicalVersionName = "6.44.3-1.0-JW"
val mollyRevision = 1
...
fun getCiEnv(name: String) = if (ciEnabled) System.getenv(name).takeIf { it.isNotBlank() } else null
...
android {
  ...
  defaultConfig {
    versionCode = canonicalVersionCode * postFixSize + abiPostFix["universal"]!! + mollyRevision // JW
