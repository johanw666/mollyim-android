...
val canonicalVersionName = "7.53.4-4474430.0-JW"
...
android {
  ...
  defaultConfig {
    ...
    buildConfigField("boolean", "MESSAGE_BACKUP_RESTORE_ENABLED", "true") // JW
  ...
  productFlavors {
    ...
    create("staging") {
      ...
      buildConfigField("String", "BUILD_ENVIRONMENT_TYPE", "\"Staging\"") // JW: keep this
